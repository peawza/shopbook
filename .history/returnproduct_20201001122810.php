                        ...
                        */
                        ...
                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <from action="returnproduct.php?action=add&id=<?php echo $rowproduct["orderrent_productid"]; ?>" method="post">
                                            ...
                                            <td class="text-center">
                                                <input class="form-control form-control-sm " type="text" name="Packagenumber" id="Packagenumber" placeholder="จำนวนหนังสือที่คืน" min='0' max="max=" <?php echo $rowproduct["orderrent_amount"]; ?>" maxlength="5" required>
                                            ...
                                            <td><input type="submit" class="btn btn-info  btn-lg btn-block btn-sm " value="คืนหนังสือ">
                                            </td>
