                ...
                <table class="table table-bordered table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th width="12%" class="text-center">คืนหนังสือ</th>
                            ...
                            <td class="text-center">
                                <from
                                    ...
                                    <?php
                                                ...
                                                echo '<br>';
                                                echo $rowproduct["orderrent_amount"];
                                                echo '<br>';
                                                echo $orderid;
                                                echo '<br>';
                                                //echo $rowproduct["Product_ID"];
                                                ...
                                                ?>
                                    <input class="form-control form-control-sm " type="text" name="returnamount"
                                        id="returnamount" placeholder="จำนวนหนังสือที่คืน" min='0' max="max="
                                        <?php echo $rowproduct["orderrent_amount"]; ?>" maxlength="3" required>
                                    <button type="submit" class="btn btn-info  btn-lg btn-block btn-sm "
                                        name="add_to_returnproduct" id="add_to_returnproduct"
                                        value="add_to_returnproduct">คืนหนังสือ</button>
                            ...
                            <td>
                                ...
                                <div class="mx-auto text-center">
                                    ...
                                    <form
                                        ...
                                        <input class="form-control form-control-sm " type="Number" name="Packagenumber"
                                            id="Packagenumber" placeholder="จำนวนหนังสือที่คืน" min='0' max="max="
