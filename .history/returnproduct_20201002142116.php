                        ...
                        <tr>
                            ...
                            <td width="21%" class="text-center">
                                <form
                                    ...
                                    <input type="hidden" name="productbuy" id="productbuy"
                                        value="<?php echo $rowproduct["product_buy"]; ?>">
            ...
            <div class="py-2">
                <table class="table table-bordered table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th width="8%" class="text-right"><?php echo $values["productbuy"] ?> บาท</th>
                ...
                <form action="php/insert.php?Order_id=<?php echo $_GET['Order_id'] ?>" method="POST">
                    <button type="submit" class="btn btn-success btn-lg  float-right  mb-2  mx-3 my-1 px-5 "
                        id="insertreturnproduct" name="insertreturnproduct">ยืนยันการคืนหนังสือ</button>
                </form>
