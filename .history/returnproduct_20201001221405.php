                ...
                <table class="table table-bordered table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th width="12%" class="text-center"><?php echo $values["item_daterent"] ?></th>
                            <th width="12%" class="text-center"><?php echo $values["item_detereturn"] ?></th>
                            <th width="6%" class="text-center"><?php echo $values["item_detereturn"] ?></th>
                            <th width="6%" class="text-center"><?php echo $values["item_detereturn"] ?></th>
                            <th width="8%" class="text-center">ค่าปรับทั้งหมด</th>
                        </tr>
                        <?php }
