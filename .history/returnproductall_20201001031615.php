                        ...
                        */
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $rowordersales["orders_sumtotal"] ?></td>
                                    ...
                                    ?>
                                        <td>
                                            <div class="mx-auto text-center">
                                                <input type="button" name=" " value="หนังสือยังคืนไม่หมด" class="btn btn-danger  btn-sm  " />
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="mx-auto text-center">
                                                <input type="button" name="edit" value="รายละเอียด" id="<?php echo $rowordersales["orders_id"]; ?>" class="btn btn-info  btn-sm  view_dataordersales" />
