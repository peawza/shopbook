...
<body>
    ...
    `productloss`.`Product_ID`,
    SUM(`productloss`.`productloss_amount`) AS `amount`,
    SUM(`productloss`.`productloss_price`) AS `price`
FROM
    `productloss`,
    `product`
WHERE
    `productloss`.`Product_ID` = `product`.`Product_ID` GROUP BY `product`.`Product_ID`";
