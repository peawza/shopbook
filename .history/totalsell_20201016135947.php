            ...
            <div class="py-2">
                <table class="table table-bordered table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        $selectproduct = "SELECT `productloss`.`Product_ID`, `product`.`Product_Name`,`product`.`Product_Photo`,`product`.`Product_Balance`, SUM(`productloss`.`productloss_amount`) AS `amount`, SUM(`productloss`.`productloss_price`) AS `price` FROM `productloss`, `product` WHERE `productloss`.`Product_ID` = `product`.`Product_ID` GROUP BY `product`.`Product_ID`";
