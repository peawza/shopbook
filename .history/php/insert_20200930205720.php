...
(
    ...
    */
    ...
    if (mysqli_num_rows($resultid) == 1) {
        ...
        INSERT INTO `orderrent`(`orderrent_id`, `orderrent_productid`, `orderrent_amount`, `orderrent_rentdate`, `orderrent_returndate`, `orderrent_status`) VALUES ([value-1],[value-2],[value-3],[value-4],[value-5],[value-6])    
        */
