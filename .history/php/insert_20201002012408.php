...
(
    ...
    */
    ...
    $sqlselectorder = ("SELECT  `orders_renttotal` FROM `orders` WHERE `orders_id`='" . $_GET[''] . "'");


    $sqlupdateorder = ("UPDATE `orders` SET `orders_returntotal`='" . $totalall . "',`orders_sumtotal`=[value-6] WHERE 1");
}