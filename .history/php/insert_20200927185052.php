...
if (isset($_POST['submitproduct'])) {
    ...
    if (move_uploaded_file($_FILES['file']['tmp_name'], $url)) {
        $sql = "INSERT INTO `product` ( `Type_ID`, `Product_Name`, `Product_Details`, `Product_Price`, `Product_Balance`, `Product_Photo`, `date_save`, `Product_rentday`) 
                            VALUES ( '" . $_POST['typeproduct'] . "', '" . $_POST['nameproduct'] . "', '" . $_POST['detail'] . "',
                                                                                        '" . $_POST['price'] . "', '" . $_POST['unit'] . "', '" . $newname . "', '" . date("Y-m-d") . "', '" . $_POST['warrantyproduct'] . "');";
