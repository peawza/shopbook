...
(
    ...
    */
    ...
    if (mysqli_num_rows($resultid) == 1) {
        ...
        $sqlinsertorder = ("INSERT INTO `orders`(`orders_id`, `User_ID`, `Order_addressuser`, `orders_renttotal`, `orders_returntotal`, `orders_sumtotal`, `orders_iscomplete`) 
        VALUES ('" . $OrderID . "','".$_POST['UserID']."','".$adressusersend."','".$_POST['Totalprice']."','0','".$_POST['Totalprice']."','0')");
        */
