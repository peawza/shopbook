    ...
    ('" . $OrderID . "','" . $_POST['Delivery'] . "','" . $_SESSION["ID"] . "','" . $adressusersend . "','" .
        ...
        */
        ...
        foreach ($_SESSION["shopping_cart"] as $keys => $values) {
            ...
            /*
            INSERT INTO `orderrent`(`orderrent_id`, `orderrent_productid`, `orderrent_amount`, `orderrent_totalprice`, `orderrent_rentdate`, `orderrent_returndate`, `orderrent_status`) 
            VALUES ('" . $OrderID . "','" . $values["item_id"] . "','" . $values["item_quantity"] . "','" . $sumprice . "',[value-4],[value-5],[value-6])
