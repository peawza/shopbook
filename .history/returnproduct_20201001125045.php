                    ...
                    [Product_datesave] => 2020-09-30
                        ...
                        */
                        ...
                        <tr>
                            ...
                            <from
                                action="returnproduct.php?action=add&id=<?php echo $rowproduct["Product_ID"]; ?>&&typeproduct=<?php echo $rowproduct["Type_ID"] ?>"
                                method="post">
                                ...
                                <td class="text-center">
                                    <input class="form-control form-control-sm " type="text" name="returnamount"
                                        ...
                                        <?php echo $rowproduct["orderrent_amount"]; ?>" maxlength="5" required>
