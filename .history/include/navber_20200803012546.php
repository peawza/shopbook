<nav class="navbar navbar-expand-lg  ">
    ...
    <a class="navbar-brand" href="index.php"><img src="img/index/logoweb.png" alt="img/index/logo.png "
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <?php
                        $conndata = new mysqli('localhost', 'root', '', 'shop');
                        ...
                        */
                        ...
                        $resultTypeproduct = mysqli_query($conndata, $selectTypeproduct);
                        ...
                        <a class="dropdown-item"
                            href="shopproduct.php?typeproduct=<?php
                                                                                        echo $row["Type_ID"];
