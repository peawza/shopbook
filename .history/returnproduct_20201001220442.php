                ...
                <table class="table table-bordered table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th width="17%" class="text-center">ชื่อหนังสือ</th>
                            <th width="10%" class="text-center">ราคาหนังสือ</th>
                            <th width="9%" class="text-center">วันที่เช่า</th>
                            <th width="15%" class="text-center">วันที่ต้องคืน</th>
                            <th width="11%" class="text-center">จำนวนหนังสือที่เช่า</th>
                            <th width="21%" class="text-center">จำนวนหนังสือที่คืน</th>
                            <th width="21%" class="text-center">ค่าปรับทั้งหมด</th>
