                ...
                <table class="table table-bordered table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="text-right"><?php echo $rowproduct["Product_Name"] ?></th>
                            <td class="text-right"><?php echo $rowproduct["Product_Balance"] ?></td>
                            <td class="text-right"><?php echo $rowproduct["amount"] ?></td>
                            <td class="text-right"><?php echo $rowproduct["price"] ?></td>
