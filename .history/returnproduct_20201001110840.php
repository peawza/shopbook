                    ...
                    <tbody>
                        ...
                        */
                        if (isset($_GET['Order_id'])) {
                            ...
                            $selectproduct = "SELECT * FROM `orders`,`user`,`orderrent` WHERE `user`.`User_ID`=`orders`.`User_ID`AND`orders`.`orders_id`= `orderrent`.`orderrent_id`AND `product`.`Product_ID`=`orderrent`. AND`orderrent`.`orderrent_id`= '" . $orderid . "'";
