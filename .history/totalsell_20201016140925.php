                ...
                <table class="table table-bordered table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="text-center"><?php echo $rowproduct["Product_ID"] ?></th>

                            <th class="text-center"><?php echo $rowproduct["Product_Name"] ?></th>
                            <td class="text-center"><?php echo $rowproduct["Product_Balance"] ?></td>
                            <td class="text-center"><?php echo $rowproduct["amount"] ?></td>
                            <td class="text-center"><?php echo $rowproduct["price"] ?></td>
